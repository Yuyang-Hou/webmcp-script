...
脚本列表的 **更新** 支持手动检查、每天检查提示、每天自动更新。支持任意直接可访问的 HTTPS 发布源，无需脚本站；本地修改或网站范围/来源变化暂停自动覆盖，新版在下次打开或刷新页面时生效。AI 也可通过 MCP 管理这些设置。见 [检查与自动更新](docs/ai-script-management.md#检查与自动更新)。
